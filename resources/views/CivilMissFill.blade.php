...
<p class="bg text-primary" style="font-size:25px;"><span >Name:</span>&nbsp Ma Han That Htar (First letters are capital!)<p>
<p class="bg text-primary" style="font-size:25px;"><span >Roll-No:</span>&nbsp VC-2 (Roll number is capital!)<p>
</div><br>
...
<a href='/civil'style="color:currentColor;cursor:not-allowed;text-decoration:none;">
