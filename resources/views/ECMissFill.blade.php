...
<p class="bg text-primary" style="font-size:25px;"><span >Name:</span>&nbsp Ma Phyu Phyu Aye (First letters are capital!)<p>
<p class="bg text-primary" style="font-size:25px;"><span >Roll-No:</span>&nbsp VEC-1 (Roll number is capital!)<p>
</div><br>
...
<a href='/ec'style="color:currentColor;cursor:not-allowed;text-decoration:none;">
