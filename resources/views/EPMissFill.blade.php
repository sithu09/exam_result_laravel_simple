...
<p class="bg text-primary" style="font-size:25px;"><span >Name:</span>&nbsp Ma Moe Thiri Kyaw (First letters are capital!)<p>
<p class="bg text-primary" style="font-size:25px;"><span >Roll-No:</span>&nbsp VEP-6 (Roll number is capital!)<p>
</div><br>
...
<a href='/ep'style="color:currentColor;cursor:not-allowed;text-decoration:none;">
