...
<p class="bg text-primary" style="font-size:25px;"><span >Name:</span>&nbsp Mg Aung Thu Phyo (First letters are capital!)<p>
<p class="bg text-primary" style="font-size:25px;"><span >Roll-No:</span>&nbsp VMP-2 (Roll number is capital!)<p>
</div><br>
